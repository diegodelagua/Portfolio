    ...
    return (
        <motion.div
            ...
            <div className='container mx-auto'>
                ...
                >
                    <TabsList className="flex flex-col w-full max-w-[380px0] mx-auto xl:mx-0 gap-6">
                                ...
                                <ul className='grid grid-cols-1 lg:grid-cols-2 gap-[30px]'>
                                    {education.items.map((item,index)=>{
                                        return(
                                            ...
                                            >
                                                <span className='text-cyan-600'>{item.duration}</span>
                                                <h3 className='text-xl max-w-[260px] min-h-[60px] text-center lg:text-left'>
                                                    {item.degree}
                                                </h3>
                                                <div className='flex items-center gap-3'>
                                                    {/*dot*/}
                                                    <span className='w-[6px] h-[6px] rounded-full bg-cyan-600'></span>
                                            ...
                                            <li key={index}>
                                                <TooltipProvider delayDuration={100}>
                                                    <Tooltip>
                                                        ...
                                                        group'>
                                                            <div className='text-6xl group-hover:text-cyan-600 transition-all duration-300'>
                                                                {skill.icon}
                                                            </div>
                                                        </TooltipTrigger>
                                                        <TooltipContent>
