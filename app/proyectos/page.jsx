...
const projects = [
    {
        ...
        github:"https://github.com/diegodelagua/Enebro",
    },
    {
        num:"02",
        category:"frontend",
        ...
        github:"https://github.com/diegodelagua/La-Funkeria",
    },
    {
        num:"03",
        category:"frontend",
        ...
        github:"https://github.com/diegodelagua/Books",
    },
]
                    ...
                    <div className="flex flex-col gap-[30px]">
                        ...
                        <ul className="flex gap-4">
                                {project.stack.map((item, index) =>{
                                    return(
                                        <li key={index} className="text-xl text-cyan-600">
                                            {item.name}
                        ...
                        <div className="flex items-center gap-4">
                                    ...
                                    <TooltipProvider delayDuration={100}>
                                        <Tooltip>
                                            <TooltipTrigger className="w-[70px] h-[70px] rounded-full bg-white/5 flex justify-center items-center group">
                                                <BsArrowUpRight className="text-white text-3xl group-hover:text-cyan-600"/>
                                            </TooltipTrigger>
                                            <TooltipContent>
                                                <p>Live project</p>
                                            </TooltipContent>
                                ...
                                <Link href={project.github}>
                                    <TooltipProvider delayDuration={100}>
                                        <Tooltip>
                                            <TooltipTrigger className="w-[70px] h-[70px] rounded-full bg-white/5 flex justify-center items-center group">
                                                <BsGithub className="text-white text-3xl group-hover:text-cyan-600"/>
                                            </TooltipTrigger>
                                            <TooltipContent>
                ...
                <div className="w-full xl:w-[50%] ">
                    ...
                    >
                        ...
                        <WorkSliderBtns
                            ...
                            btnStyles="bg-cyan-600 hover:bg-cyan-300 text-primary text-[22px] w-[34px] flex justify-center items-center transition-all"
                        />
                    </Swiper>
                </div>
            </div>
